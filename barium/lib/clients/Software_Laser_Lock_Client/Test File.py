...
##        """
        ...
        self.wm_cxn = yield connectAsync(multiplexer_config.ip, name =  ' Single Channel Lock  WM', password=self.password)
        ...
        self.cxn = yield connectAsync('flexo', name = ' Single Channel Lock', password=self.password)
        ...
        #yield self.wm.signal__frequency_changed(SIGNALID2)
        #yield self.wm.addListener(listener = self.updateBristolFrequency, source = None, ID = SIGNALID2)
    ...
    def initializeGUI(self):
        ...
        self.setWindowTitle("Laser Lock Software GUI")
        layout=QGridLayout()
        ...
        for chan in self.lasers:
            ...
            layout.addWidget(laser, self.lasers[chan][2][0], self.lasers[chan][2][1] , 1, 1)
