...
### BEGIN NODE INFO
[info]
name = Agilent 33210A Server
version = 1.3
description = 
instancename = Agilent 33210A Server
...
class AgilentServer(GPIBManagedServer):
    name = 'Agilent 33210A Server' # Server name
    deviceName = 'AGILENT TECHNOLOGIES 33210A' # Model string returned from *IDN?
