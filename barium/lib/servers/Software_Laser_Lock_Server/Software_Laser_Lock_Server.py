...
class Software_Laser_Lock_Server(LabradServer):
    ...
    def connect(self):
        ...
        self.piezo2 = self.trap_cxn.piezo_controller2
            ...
            if self.lasers[laser][6]:# == True and self.lasers[laser][4] != 4:
                ...
                if (freq < self.lasers[laser][0] + .1) and freq > (self.lasers[laser][0] -.1):
                    ...
                    if laser =="413nm" or laser == "493nm_2" or laser =="652nm":
                        yield self.piezo2.set_voltage(int(self.lasers[laser][4]),U(output, 'V')) # yield
                    else:
    ...
    def set_dac_voltage(self, c, voltage, chan):
        ...
        if chan == "413nm" or chan == "493nm_2" or chan == "652nm":
            yield self.piezo2.set_voltage(int(self.lasers[chan][4]),U(voltage, 'V'))
        else:
